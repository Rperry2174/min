...
fn migration_features() -> Vec<MigrationFeature> {
    vec![
        ...
        MigrationFeature {
            ...
            label: "Tab engine",
            status: "spike",
            notes: "create_tab / select_tab / load_url_in_tab / close_tab / set_tab_bounds implemented. Content uses the iframe fallback; native per-tab Tauri Webview instances remain the key parity gap. See docs/tauri-migration/webview-spike-gaps.md.",
        },
        MigrationFeature {
            id: "downloads",
            label: "Downloads",
